...
/* checks if the role is sufficient to enter the page. If not, the user will be redirected to 403.php (Forbidden). For example
* 
...
// logout the user, this will log the user out of the web app front-end by redirecting the user to the login.php page, and also in the database the user attribute 'ingelogd' will be set to 0 (false)
function logOut() {
