...
function uploadMovie($userId, $title, $path, $thumbnailPath, $description, $ageRating, $filmGuides, $genres){
    ...
    foreach($genres as $genre){
        ...
        executeQuery("INSERT INTO genre_film (genre_id, film_id) VALUES (?, ?)", "ii", array($genreInput, $filmIdInput['id']));
    }
    foreach($filmGuides as $filmGuide){
        ...
        executeQuery("INSERT INTO film_kijkwijzer_geschiktheid (kijkwijzer_geschiktheid_id, film_id) VALUES (?, ?)", "ii", array($filmGuideInput, $filmIdInput['id']));
    }
