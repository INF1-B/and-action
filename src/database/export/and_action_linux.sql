...
-- Database: `and_action`
--
CREATE DATABASE IF NOT EXISTS `and_action` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `and_action`;
...
INSERT INTO `abbonement` (`id`, `naam`, `kwaliteit`, `beschrijving`, `bedrag`) VALUES
(1, 'Standard', '720', 'Standard quality, 720P', 20),
(2, 'Premium', '4000', 'Premium quality, 4k', 50),
(3, 'X', '0', 'This subscription is used to attach users to that have no standard or premium subscription', 0);
...
INSERT INTO `gebruiker` (`id`, `rol_id`, `abonnement_id`, `geverifieerd`, `ingelogd`, `gebruikersnaam`, `wachtwoord`, `email`, `abbonement_eind`) VALUES
...
(3, 3, 3, 1, 0, 'test3', '$2y$17$m7PwdIgT8nubV.5mnNzNIeXijCW5T/ZFBQz4QODS.YHaUYezGKRgC', 'test3@email.nl', NULL);
...
(3, 'Fantasy & sci-fi', 'Fantasy & science fiction genre'),
...
CREATE TABLE IF NOT EXISTS `rol` (
  `id` int NOT NULL AUTO_INCREMENT,
  `naam` varchar(50) NOT NULL,
  `beschrijving` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
